...
## How does it work?
A image is written onto an SD card partition that will be used to start the Raspberry Pi (RPi). This image (refered to moving forward as the **initfs** image) contains code to both self-update and to download the final root filesystem (refered to as the **rootfs**) the RPi is going to use. 
...
## More
 * [How to Build and Test the Images Locally](https://github.com/cattlepi/cattlepi/blob/master/doc/BUILDING.md)
 * [Boot Process in Depth](https://github.com/cattlepi/cattlepi/blob/master/doc/BOOT.md)