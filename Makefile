...
makefileupdate: clean
	export TOPDIR=${current_dir} && ${current_dir}tools/cfg/build_makefile.sh

all: clean raspbian_cattlepi

# everything below is autogenerated
# 	run the makefileupdate target to rebuild this file to include all recipes

copy_initfs_mac_to_sdcard: envsetup
	@echo "make: copy_initfs_mac_to_sdcard"
	bin/myenv.sh "${current_dir}recipes/copy_initfs_mac_to_sdcard.yml"
